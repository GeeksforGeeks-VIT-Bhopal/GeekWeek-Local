[8:33 pm, 17/03/2021] Kashish khaneja:  class Solution:
    def updateMatrix(self, matrix):
        ...
        return matrix
[8:36 pm, 17/03/2021] Kashish khaneja: *Given an array of n integers nums, a 132 pattern is a subsequence of three integers nums[i], nums[j] and nums[k] such that i < j < k and nums[i] < nums[k] < nums[j].
...
[8:41 pm, 17/03/2021] Kashish khaneja: Given an array nums of n integers, are there elements a, b, c in nums such that a + b + c = 0? Find all unique triplets in the array which gives the sum of zero.
