...
/**
 ...
 8:07-8:18 passed system test (431.46 pt)
 
 editorial:
  - https://apps.topcoder.com/wiki/display/tc/SRM+663
  - http://kmjp.hatenablog.jp/entry/2015/08/01/0930
 
 Summary:
  - figured out quickly from samples and problem statement that sequence is deterministic from target to initial 👍
