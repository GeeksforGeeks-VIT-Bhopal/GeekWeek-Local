...
while True:
    ...
    if re.search('open', res):
        ...
        print(open_result)
        t2s("opening "+res+" for you divashree")
    ...
    if re.search('what can you do', res):
        ...
        ans = """I can do lots of things Divashree, for example you can ask me time, date, weather in your city,
